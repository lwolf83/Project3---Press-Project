...
namespace Project_3___Press_Project
{
    public class ContextPopulator
    {
        ...
        public void Populate()
        {
            ...
            CreateCountry();
            Console.WriteLine("Importing provinces ...");
            ImportProvincesInDB();
            Console.WriteLine("Importing departments ...");
            ImportDepartmentsInDB();
            Console.WriteLine("Importing cities ...");
            ImportCitiesInDB();
            Console.WriteLine("Linking locations ...");
            LinkLocations();

            Console.WriteLine("Creating test addresses...");
            CreateAddresses(10);
            Console.WriteLine("Creating test shops...");
            CreateShops();
            Console.WriteLine("Creating test editors...");
            CreateEditors(3);
            Console.WriteLine("Creating test newspapers ...");
            CreateNewspapers(3);
            Console.WriteLine("Creating test catalogs ...");
            CreateCatalogs(2);
            Console.WriteLine("Creating test users...");
            CreateUsers(20);
            Console.WriteLine("Linking test users...");
            LinkUserToShop();
            Console.WriteLine("Creating test shop catalogs ...");
            CreateShopCatalogs();
            Console.WriteLine("Creating test orders ...");
            CreateOrders();
            Console.WriteLine("Creating test order catalogs ...");
            CreateOrderCatalogs();
            Console.WriteLine("Creating test automatic orders ...");
        ...
        public void CreateShops()
        {
            ...
            int shopCounter = 0;
            foreach (PostalAddress adress in adresses)
            {
                Shop shop = new Shop();
